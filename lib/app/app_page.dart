enum AppPage {
  ...
  guardNotices(slug: 'guard-notices'),
  superUserDashboard(slug: 'super-user-dashboard'),
  ...
  petHub(slug: 'pet-hub'),
  petSocialFeed(slug: 'pet-social-feed'),
  petProfile(slug: 'pet-profile'),
  addPetBasicDetails(slug: 'add-pet-basic-details'),
  addPetHealthInfo(slug: 'add-pet-health-info'),
  addPetPhotoUpload(slug: 'add-pet-photo-upload'),
  addPetPreview(slug: 'add-pet-preview'),
  vaccinationDashboard(slug: 'vaccination-dashboard'),
  addVaccination(slug: 'add-vaccination'),
  vaccinationHistory(slug: 'vaccination-history'),
  petMeetups(slug: 'pet-meetups'),
  createPetMeetup(slug: 'create-pet-meetup'),
  createPetPost(slug: 'create-pet-post'),
  bookPetZone(slug: 'book-pet-zone'),
  petStores(slug: 'pet-stores'),
  petAdoptionCenter(slug: 'pet-adoption-center'),
  vetDirectory(slug: 'vet-directory'),
